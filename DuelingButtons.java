...
rightButton.setText("C-C-C-C-CALICK ME.");
...
frame.setTitle("Demanding Buttons!");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed.equals(leftButton)) {
			rightButton.setText("NO! CLICK ME YOU IGNORANT FOOL.");
			rightButton.setSize(BIG);
			leftButton.setText("CLICK MEE! >:o");
		...
		if(buttonPressed.equals(rightButton)) {
			leftButton.setText("NO! CLICK ME YOU IGNORANT FOOL.");
			leftButton.setSize(BIG);
			rightButton.setText("CLICK MEE! >:o");
