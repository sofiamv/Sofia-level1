...
frame.setVisible(true);
		...
		JPanel header = createHeader("Sea");		
...
frame.add(quizPanel);
	...
	quizPanel.add(firstButton);	
		...
		fifthButton = createButton("its over 9000 yo");
...
thirdButton.addActionListener(this);
	...
	private JButton createButton(String dollarAmount) {
		...
		JButton jeopardie = new JButton();
		// Set the text of the button to the dollarAmount
		jeopardie.setText(dollarAmount);
...
playJeopardyTheme();
		...
		askQuestion("How many oceans are there on Earth?", "5", 200);
...
if(buttonPressed.equals(secondButton)) {
	askQuestion("What percentage of the earth is covered by the ocean?", "70", 400);
	secondButton.setText(null);
}
if(buttonPressed.equals(thirdButton)) {
	askQuestion("The pacific ocean is surrounded by the ring of fire, which is a large armount of:", "active volcanoes", 600);
	thirdButton.setText(null);
}
if(buttonPressed.equals(fourthButton)) {
	askQuestion("What is the deeepest point in the ocean, in feet?", "36070", 800);
	fourthButton.setText(null);
}
if(buttonPressed.equals(fifthButton)) {
	askQuestion("What is Sofia's favorite sea animal?", "axlotl", 9000);
	fifthButton.setText(null);
}

			// Call the askQuestion() method with a harder question the the the the the the the the the t eht ehet whtwyhsk;ogaghlhlglgl
	...
	String answer = JOptionPane.showInputDialog(question);
		...
		if(answer.equals(correctAnswer)) {
			score+=prizeMoney;
			updateScore();
			JOptionPane.showMessageDialog(null, "Positively correct! gnarly");
		}else {
			score-=prizeMoney;
			JOptionPane.showMessageDialog(null, "Incorrect, idiot. It's " + correctAnswer + "!");
			updateScore();
		}
